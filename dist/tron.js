...
export const hex40FromBase58 = (addr) => tron.address.toHex(addr).replace(/^0x/, '').toLowerCase().slice(-40);
export const base58FromHex40 = (hex40) => tron.address.fromHex('0x' + (hex40.startsWith('0x') ? hex40.slice(2) : hex40));
